<?php 
/**
 * Шаблон печати Жалоб (протокол)
 */
?>
<form action="" method="post">
	<!-- Печать страницы!!! -->
	<div id="print_button"> 
		<input type=button value="Печать" onClick="document.getElementById('print_button').style.display='none';document.getElementById('print_button2').style.display='none'; window.print();location='index.php?c=printgaloba&id=<?=$_GET['id']?>';" name="print"> 
	</div>
...
<table  style="border-collapse: collapse; border: solid black; border: 1px solid black;" width="820px">
...
<?php if ($priz['voenkomat'] == "Дзержинский") echo "Дзержинскому и Калининскому города Новосибирск" ?>		
<?php if ($priz['voenkomat'] == "Калининский") echo "Дзержинскому и Калининскому города Новосибирск" ?>			
<?php if ($priz['voenkomat'] == "Заельцовский") echo "Дзержинскому и Калининскому города Новосибирск" ?>		
<?php if ($priz['voenkomat'] == "Ленинский") echo "Кировскому и Ленинскому районам города Новосибирск" ?>		
<?php if ($priz['voenkomat'] == "Кировский") echo "Кировскому и Ленинскому районам города Новосибирск" ?>		
<?php if ($priz['voenkomat'] == "Октябрьский") echo "Октябрьскому району и Центральному округу города Новосибирск" ?>		
<?php if ($priz['voenkomat'] == "Железнодорожный") echo "Октябрьскому району и Центральному округу города Новосибирск" ?>			
<?php if ($priz['voenkomat'] == "Центральный округ") echo "Октябрьскому району и Центральному округу города Новосибирск" ?>			
<?php if ($priz['voenkomat'] == "Советский") echo "Советскому и Первомайскому районам города Новосибиск" ?>			
<?php if ($priz['voenkomat'] == "Первомайский") echo "Советскому и Первомайскому районам города Новосибиск" ?>															
...
<div style="text-align: left;">Диагноз: <?=$priz['vx_diagnoz']?></span><br><br><br><br></div>

<?php if ($priz['vx_godnost'] == "А"):?>
<b>
Категория годности <br> «А» годен к военной службе. <br>
Статья 22 – призвать на 
военную службу. <br>
Статья – <?=$priz['vx_st']?> <br>
Протокол № <?=$priz['protocol_numb']?> <br>
<?=$priz['date_protocol']?>г.

</b>
<?php endif; ?>

<?php if ($priz['vx_godnost'] == "Б"):?>
<b>
Категория годности <br> «Б» годен к военной службе с незначительными ограничениями.<br>
Статья 22 – призвать на 
военную службу. <br>
Статья – <?=$priz['vx_st']?> <br>
Протокол № <?=$priz['protocol_numb']?> <br>
...
<div style="white-space: pre-wrap;"><? if (($priz['zaloby'] == "Нет") or ($priz['zaloby'] == "нет")):?>Жалоб: <?=$priz['zaloby']?><? else:?>Жалобы: <?=$priz['zaloby']?><?endif;?><br><?=$priz['anamnez']?><br>Не согласен с решением РПК.</div>
</td>
</tr>
...
<tr style="text-align: center; overflow: hidden;" height="1000px">
<td style="border-collapse: collapse; border: solid black; border: 1px solid black; text-align: left; overflow: hidden;" width="600px" valign="top" align="top">
<div style="white-space: pre-wrap;"><font face="Times New Roman" style="font-size: <?php if (strlen($priz['rsi'])>2300 or strlen($priz['doi'])>2300):?>10pt;<?php else:?> 12pt; <?php endif;?>"><?=$priz['doi']?><? if ($priz['rsi'] == ""):  else: echo $priz['rsi']; endif;?><br>Диагноз: <?=$priz['diagnoz']?></font></div>		
...
<?php if (($priz['vx_godnost'] == "А" and $priz['godnost'] == "В") or ($priz['vx_godnost'] == "Б" and $priz['godnost'] == "В")):?>
<b>
...
<br> о призыве на военную службу отменено призывной <br> комиссией <br> Новосибирской <br> области<br> 		
...
<?php if (($priz['vx_godnost'] == "А") and ($priz['godnost'] == "Г") or ($priz['vx_godnost'] == "Б") and ($priz['godnost'] == "Г")):?>
<b>
Решение призывной <br>
комиссии<br>
<?php if ($priz['voenkomat'] == "Барабинский") echo "Барабинского района Новосибирской области" ?>
