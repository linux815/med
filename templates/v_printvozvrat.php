...
<form action="" method="post">
	<!-- Печать страницы!!! -->
	<div id="print_button"> 
		<input type=button value="Печать" onClick="document.getElementById('print_button').style.display='none';document.getElementById('print_button2').style.display='none'; window.print();location='index.php?c=printvozvrat&id=<?=$_GET['id']?>';" name="print"> 
	</div>
...
<table  style="border-collapse: collapse; border: solid black; border: 1px solid black;" width="800px">
	...
	<tr style="text-align: center;" height="1040px">
		...
		<td style="border-collapse: collapse; border: solid black; border: 1px solid black; text-align: center;" width="260px" valign="top" align="top">
			...
			<?php if ($priz['voenkomat'] == "Октябрьский")		 echo "Октябрьскому району и Центральному административному округу" ?>		
			<?php if ($priz['voenkomat'] == "Железнодорожный")	 echo "Октябрьскому району и Центральному административному округу" ?>			
			<?php if ($priz['voenkomat'] == "Центральный округ") echo "Октябрьскому району и Центральному административному округу" ?>			
		...
		<b>
			...
			военную службу. <br>
			Показатель предназначения - 1 <br>
		...
		<b>
			...
			Статья 22 – призвать на 
			военную службу. <br>
			Показатель предназначения - <?php if (($priz['vx_godnost'] == "Б") and ($priz['godnost'] == "О")): echo "3"; else: ?> 4 <?php endif;?><br>
			Статья – <?=$priz['vx_st']?> <br>
			Протокол № <?=$priz['protocol_numb']?> <br>
			<?=$priz['date_protocol']?>г.
		</b>
...
<table  style="border-collapse: collapse; border: solid black; border: 1px solid black; margin-left: 40px;" width="820px">
	...
	<tr style="text-align: center;" height="1000px">
		<td style="border-collapse: collapse; border: solid black; border: 1px solid black; text-align: left;" width="600px" valign="top" align="top">
			<div style="white-space: pre-wrap;"><?=$priz['doi']?><? if ($priz['rsi'] == ""):  else: echo $priz['rsi']; endif;?><br>Диагноз: <?=$priz['diagnoz']?></div>		
		</td>
		...
		<?php if ($priz['godnost'] == "А" or $priz['godnost'] == "А1" or $priz['godnost'] == "А2" or $priz['godnost'] == "А3" or $priz['godnost'] == "А4"):?>
		<b>
		...
		<?php if ($priz['godnost'] == "Б" or $priz['godnost'] == "Б1" or $priz['godnost'] == "Б2" or $priz['godnost'] == "Б3" or $priz['godnost'] == "Б4"):?>
		<b>
			Статья <?=$priz['isx_st']?> <br>
		...
		<?php if (($priz['vx_godnost'] == "А" and $priz['godnost'] == "А") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "А1") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "А2") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "А3") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "А4") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "Б") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "Б1") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "Б2") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "Б3") or ($priz['vx_godnost'] == "А" and $priz['godnost'] == "Б4") or ($priz['vx_godnost'] == "Б" and $priz['godnost'] == "А") or ($priz['vx_godnost'] == "Б" and $priz['godnost'] == "Б")): ?>
		<b>
		...
		<?php if ((($priz['vx_godnost'] == "А") and ($priz['godnost'] == "В")) or ((($priz['vx_godnost'] == "Б") and ($priz['godnost'] == "В")) or ((($priz['vx_godnost'] == "В") and $priz['godnost'] == "Д")))):?>
		<b>
		Решение призывной <br>
		комиссии<br>
		<?php if ($priz['voenkomat'] == "Барабинский")		echo "Барабинского района Новосибирской области" 	?>
		...
		<?php if ($priz['voenkomat'] == "Советский") 		echo "Советского района г. Новосибирска"			?>			
		<?php if ($priz['voenkomat'] == "Первомайский") 	echo "Первомайского района г. Новосибирска"			?>		
		о призыве на военную службу отменено призывной комиссией Новосибирской области от
		<?=$priz['date_protocol2']?>г. принято решение в соответствии со
		ст.28 п.1 ФЗ
		«О воинской обязанности  и военной службе» - освободить от призыва на военную службу, зачислить в запас. <br>
		Протокол  № <?=$priz['protocol_numb2']?> <br>
		Служебное письмо <br>
		от <?=$priz['date_protocol2']?>г. <br>
		№ <?=$priz['mail']?>
		...
		<?php if ($priz['voenkomat'] == "Советский") 		echo "Советского района г. Новосибирска"			?>			
		<?php if ($priz['voenkomat'] == "Первомайский") 	echo "Первомайского района г. Новосибирска"			?>	
		<br> о призыве на военную службу отменено призывной комиссией Новосибирской области от 
		<?=$priz['date_protocol2']?>г. <br> Направить на дополнительное обследование <br>
		Протокол  № <?=$priz['protocol_numb2']?> <br>
		Служебное письмо <br>
		от <?=$priz['date_protocol2']?>г. <br>
		№ <?=$priz['mail']?>
		...
		<?php if (($priz['vx_godnost'] == "Б") and ($priz['godnost'] == "Г") or ($priz['vx_godnost'] == "А") and ($priz['godnost'] == "Г")):?>
		<b>
		Решение призывной <br>
		комиссии<br>
		<?php if ($priz['voenkomat'] == "Барабинский")		echo "Барабинского района Новосибирской области" 	?>
		...
		<?=$priz['date_protocol2']?>г. принято решение в соответствии со
		ст.24 п.1 «а» ФЗ
		«О воинской обязанности  и военной службе» - предоставить отсрочку от призыва на военную службу <?=$priz['ispolnitel']?>. <br>
		Протокол  № <?=$priz['protocol_numb2']?> <br>
		Служебное письмо <br>
		от <?=$priz['date_protocol2']?>г. <br>
		№ <?=$priz['mail']?>
