...
<form action="" method="post">
	<!-- Печать страницы!!! -->
	<div id="print_button"> 
		<input type=button value="Печать" onClick="document.getElementById('print_button').style.display='none';document.getElementById('print_button2').style.display='none'; window.print();location='index.php?c=mail&id=<?=$_GET['id']?>';" name="print"> 
	</div>
...
<table width="820px" style="border: 1px black; padding-top: 40px; padding-left: 30px; padding-right: 30px; padding-aling: justify; ">
	...
	<tr>
		<td align="justify" COLSPAN=2>
			<font face="Times New Roman" style="font-size: 16.5pt;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;В соответствии с решением призывной комиссии  Новосибирской области  протокол  № <?=$priz['protocol_numb2']?> от  <?=$priz['date_protocol2']?> г.  <?=$priz['fio']?>    
			<?php $a = substr($priz['daterogdenia'],6, 10); echo $a;?>г.   признан  по  ст.<?=$priz['isx_st']?> графы <?=$priz['graf']?> расписания болезней и ТДТ (приложение к Положению о военно-врачебной экспертизе, утвержденному постановлением  Правительства РФ 2003 года № 123). 
			...
			<?php if ($priz['godnost'] == "Г") echo "«Г» - временно не годен к военной службе"?>				
	...
	<tr>
		<td align="center" COLSPAN=2>
			<font face="Times New Roman" style="font-size: 14pt;">
				ПРЕДСЕДАТЕЛЬ ВВК ВК НОВОСИБИРСКОЙ ОБЛАСТИ	
			</font>
		</td>
	</tr>
	<tr>
		<td align="right" COLSPAN=2 style="padding-top: 7px;"> 
			<font face="Times New Roman" style="font-size: 14pt;">
				<span style="margin-right: 160px; margin-top: 14px;">
					Е. ШВЕДОВ
				</span>
			</font>
		</td>
